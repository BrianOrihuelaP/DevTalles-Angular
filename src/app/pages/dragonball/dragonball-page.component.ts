...
export class DragonballPageComponent {
  ...
  characters = signal<DragonballCharacter[]>([
    { id: 1, name: 'Goku', ki: 12000, transformation: 'Super Saiyan', imageSrc: 'https://pre00.deviantart.net/8c98/th/pre/i/2016/231/3/a/super_saiyan_2_goku_by_brusselthesaiyan-daek479.png' },
    ...
    { id: 3, name: 'Gohan', ki: 15000, transformation: 'Ultimate', imageSrc: 'https://cdn.wallpapersafari.com/91/44/blQ5tU.jpg' },
    { id: 4, name: 'Krilin', ki: 1000, transformation: 'Normal', imageSrc: 'https://eltallerdehector.com/wp-content/uploads/2022/08/Krillin-png.png' },
  ]);
